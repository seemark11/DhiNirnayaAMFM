# -*- coding: utf-8 -*-
"""
Classification training and evaluation pipeline.

This script:
1. Loads extracted AM–FM feature datasets (train/test)
2. Performs hyperparameter optimization using Optuna
3. Trains SVM and Decision Tree classifiers
4. Evaluates models on train and test sets
5. Saves trained models, metrics, and SHAP explanations
